...
export function ItemDialog({
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {
    ...
    if (name === 'quantity') {
      ...
      setFormData((prev: typeof formData) => ({ ...prev, [name]: numValue }));
      ...
      try {
        ...
        setFormData((prev: typeof formData) => ({ ...prev, [name]: jsonValue }));
      } catch {
        // If not valid JSON, store as a string in a specifications object
        setFormData((prev: typeof formData) => ({ ...prev, [name]: { text: value } }));
      }
    } else {
