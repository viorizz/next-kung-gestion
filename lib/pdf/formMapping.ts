export class PDFMappingService {
  ...
  interface FieldMapping {
    ...
    // Ajouter ces fonctions à votre fichier lib/pdf/formMapping.ts existant

  import { Article, ComaxTypeAArticle } from '@/types/item';
  ...
  static mapToPDFFields(article: Article): Record<string, string> {
    switch (article.type) {
      case 'COMAX_TYPE_A':
  ...
  private static mapComaxTypeA(article: ComaxTypeAArticle): Record<string, string> {
